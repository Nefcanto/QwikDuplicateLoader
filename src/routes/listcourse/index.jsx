...
const index = () => {
    return <>
        ...
        <section class="bg-paydar-color2">
            <div class="relative max-w-7xl mx-auto px-3 xl:px-0 pt-5 md:pt-20 pb-20 md:pb-44">
                <h1 class="text-2xl sm:text-3xl md:text-4xl text-paydar-color31 mb-5">
                    consectetur
                </h1>
                <h2 class="text-paydar-color22">
        ...
        <section class="relative -mt-14  md:-mt-24 mb-20">
            <div className="relative max-w-7xl mx-auto px-3 xl:px-0 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4 gap-4 md:gap-y-14">
                {
                    [1, 2, 3, 4, 5, 6]?.map(item => <>
                        <div key={item?.id} class='max-w-full w-[330px] sm:w-full shadow-md rounded-2xl group self-stretch overflow-hidden mx-auto'>
                            ...
                            <div class="relative">
                                <Image
                                    containerClass="max-w-[330px] w-full sm:max-w-full aspect-[1/.7] object-cover"
                                    imageClass=""
